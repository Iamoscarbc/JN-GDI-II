...
<div class="text-center" style="padding-top:100px">	
		<a class="btn btn-outline-warning" href="index.html"><i class="fas fa-reply"></i> Regresar a la Página Principal</a><br> 
		<!-- Button HTML (to Trigger Modal) -->
		<a href="#myModal" class="btn btn-outline-primary trigger-btn" data-toggle="modal">Desplegar Login</a>  
</div>
